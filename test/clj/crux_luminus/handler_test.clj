(ns crux-luminus.handler-test
  (:require
    [clojure.test :refer :all]
    [ring.mock.request :refer :all]
    [crux-luminus.handler :refer :all]
    [crux-luminus.middleware.formats :as formats]
    [muuntaja.core :as m]
    [mount.core :as mount]))
...
(use-fixtures
  :once
  (fn [f]
    (mount/start #'crux-luminus.config/env
                 #'crux-luminus.handler/app-routes)
    (f)))
